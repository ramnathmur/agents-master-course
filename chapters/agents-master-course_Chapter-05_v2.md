# Chapter 5 — Perceive: What the Agent Sees  [v2]
...
> **Tell Ram:** "Copy `chapter_05_perceive.py`. Note the Version A and Version B descriptions — comment one out and uncomment the other to compare."

Run the same task with both. Observe: sparse description → more clarifying questions, wider tool-call attempts, more failures. Rich description → focused tool use.
